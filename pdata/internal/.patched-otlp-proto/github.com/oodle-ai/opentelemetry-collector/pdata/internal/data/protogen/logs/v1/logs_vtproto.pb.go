...
func (m *ResourceLogs) CloneVT() *ResourceLogs {
	...
	if rhs := m.DeprecatedScopeLogs; rhs != nil {
		tmpContainer := make([]*ScopeLogs, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.DeprecatedScopeLogs = tmpContainer
	}
...
func (this *ResourceLogs) EqualVT(that *ResourceLogs) bool {
	...
	if len(this.DeprecatedScopeLogs) != len(that.DeprecatedScopeLogs) {
		return false
	}
	for i, vx := range this.DeprecatedScopeLogs {
		vy := that.DeprecatedScopeLogs[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &ScopeLogs{}
			}
...
func (m *ResourceLogs) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.DeprecatedScopeLogs) > 0 {
		for iNdEx := len(m.DeprecatedScopeLogs) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.DeprecatedScopeLogs[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceLogs) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.DeprecatedScopeLogs) > 0 {
		for iNdEx := len(m.DeprecatedScopeLogs) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.DeprecatedScopeLogs[iNdEx].MarshalToSizedBufferVTStrict(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceLogs) ResetVT() {
	if m != nil {
		...
		f0 := m.ScopeLogs[:0]
		for _, mm := range m.DeprecatedScopeLogs {
			mm.ResetVT()
		}
		f1 := m.DeprecatedScopeLogs[:0]
		m.Reset()
		m.ScopeLogs = f0
		m.DeprecatedScopeLogs = f1
	}
}
...
func (m *ResourceLogs) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1000:
			...
			if len(m.DeprecatedScopeLogs) == cap(m.DeprecatedScopeLogs) {
				m.DeprecatedScopeLogs = append(m.DeprecatedScopeLogs, &ScopeLogs{})
			} else {
				m.DeprecatedScopeLogs = m.DeprecatedScopeLogs[:len(m.DeprecatedScopeLogs)+1]
				if m.DeprecatedScopeLogs[len(m.DeprecatedScopeLogs)-1] == nil {
					m.DeprecatedScopeLogs[len(m.DeprecatedScopeLogs)-1] = &ScopeLogs{}
				}
			}
			if err := m.DeprecatedScopeLogs[len(m.DeprecatedScopeLogs)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResourceLogs) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1000:
			...
			if err := m.DeprecatedScopeLogs[len(m.DeprecatedScopeLogs)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
