...
func (m *ResourceMetrics) CloneVT() *ResourceMetrics {
	...
	if rhs := m.DeprecatedScopeMetrics; rhs != nil {
		tmpContainer := make([]*ScopeMetrics, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.DeprecatedScopeMetrics = tmpContainer
	}
...
func (this *ResourceMetrics) EqualVT(that *ResourceMetrics) bool {
	...
	if len(this.DeprecatedScopeMetrics) != len(that.DeprecatedScopeMetrics) {
		return false
	}
	for i, vx := range this.DeprecatedScopeMetrics {
		vy := that.DeprecatedScopeMetrics[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &ScopeMetrics{}
			}
...
func (m *ResourceMetrics) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.DeprecatedScopeMetrics) > 0 {
		for iNdEx := len(m.DeprecatedScopeMetrics) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.DeprecatedScopeMetrics[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceMetrics) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.DeprecatedScopeMetrics) > 0 {
		for iNdEx := len(m.DeprecatedScopeMetrics) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.DeprecatedScopeMetrics[iNdEx].MarshalToSizedBufferVTStrict(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceMetrics) ResetVT() {
	if m != nil {
		...
		f0 := m.ScopeMetrics[:0]
		for _, mm := range m.DeprecatedScopeMetrics {
			mm.ResetVT()
		}
		f1 := m.DeprecatedScopeMetrics[:0]
		m.Reset()
		m.ScopeMetrics = f0
		m.DeprecatedScopeMetrics = f1
	}
}
...
func (m *ResourceMetrics) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1000:
			...
			if len(m.DeprecatedScopeMetrics) == cap(m.DeprecatedScopeMetrics) {
				m.DeprecatedScopeMetrics = append(m.DeprecatedScopeMetrics, &ScopeMetrics{})
			} else {
				m.DeprecatedScopeMetrics = m.DeprecatedScopeMetrics[:len(m.DeprecatedScopeMetrics)+1]
				if m.DeprecatedScopeMetrics[len(m.DeprecatedScopeMetrics)-1] == nil {
					m.DeprecatedScopeMetrics[len(m.DeprecatedScopeMetrics)-1] = &ScopeMetrics{}
				}
			}
			if err := m.DeprecatedScopeMetrics[len(m.DeprecatedScopeMetrics)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResourceMetrics) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1000:
			...
			if err := m.DeprecatedScopeMetrics[len(m.DeprecatedScopeMetrics)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
