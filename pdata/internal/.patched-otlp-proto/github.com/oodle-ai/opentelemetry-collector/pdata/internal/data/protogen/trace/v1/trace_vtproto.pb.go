...
func (m *ResourceSpans) CloneVT() *ResourceSpans {
	...
	if rhs := m.DeprecatedScopeSpans; rhs != nil {
		tmpContainer := make([]*ScopeSpans, len(rhs))
		for k, v := range rhs {
			tmpContainer[k] = v.CloneVT()
		}
		r.DeprecatedScopeSpans = tmpContainer
	}
...
func (this *ResourceSpans) EqualVT(that *ResourceSpans) bool {
	...
	if len(this.DeprecatedScopeSpans) != len(that.DeprecatedScopeSpans) {
		return false
	}
	for i, vx := range this.DeprecatedScopeSpans {
		vy := that.DeprecatedScopeSpans[i]
		if p, q := vx, vy; p != q {
			if p == nil {
				p = &ScopeSpans{}
			}
...
func (m *ResourceSpans) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.DeprecatedScopeSpans) > 0 {
		for iNdEx := len(m.DeprecatedScopeSpans) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.DeprecatedScopeSpans[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceSpans) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.DeprecatedScopeSpans) > 0 {
		for iNdEx := len(m.DeprecatedScopeSpans) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.DeprecatedScopeSpans[iNdEx].MarshalToSizedBufferVTStrict(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ResourceSpans) ResetVT() {
	if m != nil {
		...
		f0 := m.ScopeSpans[:0]
		for _, mm := range m.DeprecatedScopeSpans {
			mm.ResetVT()
		}
		f1 := m.DeprecatedScopeSpans[:0]
		m.Reset()
		m.ScopeSpans = f0
		m.DeprecatedScopeSpans = f1
	}
}
...
func (m *ResourceSpans) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1000:
			...
			if len(m.DeprecatedScopeSpans) == cap(m.DeprecatedScopeSpans) {
				m.DeprecatedScopeSpans = append(m.DeprecatedScopeSpans, &ScopeSpans{})
			} else {
				m.DeprecatedScopeSpans = m.DeprecatedScopeSpans[:len(m.DeprecatedScopeSpans)+1]
				if m.DeprecatedScopeSpans[len(m.DeprecatedScopeSpans)-1] == nil {
					m.DeprecatedScopeSpans[len(m.DeprecatedScopeSpans)-1] = &ScopeSpans{}
				}
			}
			if err := m.DeprecatedScopeSpans[len(m.DeprecatedScopeSpans)-1].UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ResourceSpans) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1000:
			...
			if err := m.DeprecatedScopeSpans[len(m.DeprecatedScopeSpans)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
